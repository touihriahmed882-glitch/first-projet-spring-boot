...
namespace serviceoncologie.Migrations
{
    ...
    [Migration("20250316153235_ajouterentity")]
    partial class ajouterentity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("serviceoncologie.Data.Models.User", b =>
                {
                    ...
                    b.Property<int?>("CommissionStaffId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("serviceoncologie.Data.Models.User", b =>
                {
                    b.HasOne("serviceoncologie.Data.Models.CommissionStaf", "CommissionStaf")
                        .WithMany("Medecins")
                        .HasForeignKey("CommissionStaffId");
